          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <h2>
                ...
                <img
                  src={InitImage}
                  alt="Mecha Golem"
                  style={{ width: "380px", height: "380px", borderRadius: 40 }}
                />
              </h2>
            </div>
            <br />
            ...
            <div className="block-text">
              <h3 className="heading">
                Join us for great Events and alphas
                <br />
                While interacting with like minded creators
              </h3>
              <a
                href="https://discord.com/invite/4mXg6QSyY8"
                className="action-btn"
              >
                <span style={{ width: 540 }}>
                  Get Connected, wild adventures await you
                </span>
              </a>

              <h2 className="heading">
                <br />
                Ancestor Timeline Evolutions & Skins
              </h2>
            </div>
          </div>
        </div>
